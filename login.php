...
<head>
    ...
    <style>
        ...
        .form-title { font-family: 'Outfit', sans-serif; font-size: 1.85rem; font-weight: 800; color: #1a1d23; margin-bottom: 0.5rem; }
        .form-subtitle { color: #5f6980; font-size: 1rem; font-weight: 400; }

        .input-group { margin-bottom: 1.5rem; }
        .input-group label { display: block; font-weight: 600; font-size: 0.82rem; margin-bottom: 0.6rem; color: #1a1d23; }
        .input-group input { 
            width: 100%; 
        ...
        .btn-sign-in:hover { background: #0f766e; transform: translateY(-1px); box-shadow: 0 6px 16px rgba(13, 148, 136, 0.25); }
        ...
        .btn-google {
            ...
            color: #1a1d23; text-decoration: none; font-weight: 700; font-size: 0.9rem;
            transition: all 0.2s ease;
        }
        .btn-google:hover { background: #f8fafc; border-color: #cbd5e1; }
        .google-icon { width: 18px; height: 18px; }

        .signup-prompt { text-align: center; margin-top: 2rem; font-size: 0.85rem; color: #5f6980; }
        .signup-link { color: #0d9488; font-weight: 700; text-decoration: none; }
