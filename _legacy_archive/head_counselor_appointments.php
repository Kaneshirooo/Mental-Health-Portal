...
<div class="container" style="max-width: 1200px; padding-top: 1.5rem; padding-bottom: 3rem;">
            ...
            <table style="width: 100%; border-collapse: collapse; text-align: left;">
                ...
                <tr style="border-bottom: 1px solid var(--border);">
                    ...
                    <td style="padding: 1rem 1.25rem; text-align: right;">
                        <button type="button" onclick="document.getElementById('override_<?php echo $a['appointment_id']; ?>').style.display='flex'" style="padding: 0.45rem 1rem; border-radius: 6px; border: 1.5px solid var(--border); background: var(--surface-solid); color: var(--text); font-weight: 600; font-size: 0.78rem; cursor: pointer; transition: var(--transition);">Override</button>
                        <div id="override_<?php echo $a['appointment_id']; ?>" style="display:none; position: fixed; inset: 0; z-index: 9999; background: rgba(15, 23, 42, 0.45); backdrop-filter: blur(4px); align-items: center; justify-content: center;" onclick="if(event.target===this) this.style.display='none'">
                            <div style="background: var(--surface-solid); border-radius: var(--radius); padding: 2rem; max-width: 400px; width: 90%; box-shadow: var(--shadow-lg); text-align: left; border: 1px solid var(--border);" onclick="event.stopPropagation()">
    ...
    <?php if ($tab === 'schedules'): ?>
        ...
        <div style="display: grid; gap: 2rem;">
            ...
            <div style="background: var(--surface-solid); border-radius: 24px; padding: 2rem; border: 1px solid var(--border);">
