        ...
        <div class="card" style="padding: 1.5rem; border-radius: var(--radius);">
            ...
            <form method="POST" id="availForm">
                ...
                <div style="margin-top: 2rem; display: flex; gap: 0.75rem;">
                    ...
                    <a href="counselor_dashboard.php" class="btn-secondary" style="flex: 1; padding: 0.85rem; border-radius: var(--radius-sm); font-weight: 600; border: 1.5px solid var(--border); text-align: center; text-decoration: none; color: var(--text-dim); background: var(--surface-solid); font-size: 0.9rem;">Cancel</a>
                </div>
            </form>
        </div>
    </div>
