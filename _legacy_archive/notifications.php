...
<head>
    ...
    <style>
        ...
        .notif-card.unread { background: var(--surface-2); border-color: var(--primary-light); }
        .notif-icon {
...
<div class="container" style="max-width: 650px; padding-top: 1.5rem; padding-bottom: 3rem;">
    ...
    <div style="text-align: center; padding: 4rem 2rem; background: var(--surface-solid); border-radius: var(--radius); border: 2px dashed var(--border);">
    ...
    <div style="display:flex; flex-direction:column; gap:1rem;">
        ...
        $typeBg = 'var(--surface-2)';
        $typeClr = ['appointment' => 'var(--primary)', 'system' => 'var(--text-dim)'][$n['type']] ?? 'var(--text-dim)';
...
?>
    ...
    <div style="margin-top: 1.5rem; text-align: center;">
        <button id="clearAllBtn" onclick="clearAllAjax()" style="background: var(--surface-solid); border: 1px solid var(--border); padding: 0.65rem 1.75rem; border-radius: var(--radius-sm); font-weight: 600; color: var(--text-muted); cursor: pointer; font-size: 0.85rem; transition: var(--transition);">Clear Feed</button>
    </div>
    <?php
endif; ?>
</div>
