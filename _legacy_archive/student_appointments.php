...
if ($avail_res) {
    while ($av = $avail_res->fetch_assoc())
        $availability[$av['counselor_id']][] = $av;
}
?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <div style="flex:1; min-width:0;">
                        <div style="display:flex; justify-content:space-between; align-items:flex-start; margin-bottom:0.25rem;">
                            ...
                            <div style="display:flex; align-items:center; gap:0.5rem;">
                                <?php if ($st === 'confirmed' || $st === 'requested'): ?>
                                <a href="add_to_calendar.php?id=<?php echo $a['appointment_id']; ?>" title="Add to Calendar" style="text-decoration:none; font-size:0.95rem; opacity:0.6; transition:var(--transition); filter:grayscale(100%);" onmouseover="this.style.opacity='1';this.style.filter='grayscale(0%)'" onmouseout="this.style.opacity='0.6';this.style.filter='grayscale(100%)'">📅</a>
                                <?php
        endif; ?>
