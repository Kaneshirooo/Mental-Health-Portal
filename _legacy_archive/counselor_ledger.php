...
<div class="container" style="max-width: 1200px; padding-top: 1.5rem; padding-bottom: 3rem;">
    ...
    <div style="background: white; border-radius: var(--radius); padding: 1.5rem; border: 1px solid var(--border); box-shadow: var(--shadow-sm); margin-bottom: 2rem; display: flex; gap: 1rem; align-items: center;">
        <form method="GET" style="display: flex; gap: 1rem; flex: 1;">
            ...
            <a href="export_ledger.php?search=<?php echo urlencode($search); ?>&role=<?php echo urlencode($role_filter); ?>" style="padding: 0.75rem 1.25rem; border-radius: var(--radius-sm); background: white; border: 1.5px solid var(--border); color: var(--text); font-weight: 700; text-decoration: none; display: flex; align-items: center; gap: 0.5rem; font-size: 0.85rem; margin-left: auto;">
