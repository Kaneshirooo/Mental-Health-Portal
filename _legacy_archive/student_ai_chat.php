        ...
        <div class="chat-interface">
            ...
            <div class="chat-actions">
                <div style="display:flex; gap:1rem;">
                    ...
                    <button onclick="clearChat()" style="background:var(--surface-solid); border:1.5px solid var(--border); padding:0.85rem 1.75rem; border-radius:50px; font-weight:800; font-size:0.85rem; color:var(--text-dim); cursor:pointer;">CLEAR</button>
                </div>
