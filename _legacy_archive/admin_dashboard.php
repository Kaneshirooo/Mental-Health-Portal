...
<div class="container" style="max-width: 1200px; padding-top: 1.5rem; padding-bottom: 3rem;">
    ...
    <div style="display: flex; justify-content: space-between; align-items: flex-end; margin-bottom: 2.5rem;">
        ...
        <div style="display: flex; gap: 0.75rem;">
            ...
            <button onclick="location.reload()" style="padding: 0.65rem 1.25rem; border-radius: var(--radius-sm); border: 1px solid var(--border); background: var(--surface-solid); font-weight: 600; cursor: pointer; font-size: 0.82rem; color: var(--text-muted);">Refresh</button>
        </div>
    </div>
