...
<div class="container" style="max-width: 1100px; padding-top: 1.5rem; padding-bottom: 3rem;">
    ...
    <!-- Aria's Insight Card -->
    <div id="ariaInsightCard" style="background: linear-gradient(135deg, #f0f9ff 0%, #e0f2fe 100%); border: 1px solid #bae6fd; border-radius: var(--radius); padding: 1.5rem 2rem; margin-bottom: 2.5rem; display: flex; gap: 1.5rem; align-items: center; box-shadow: var(--shadow-sm); animation: fade-up 0.6s ease-out;">
        <div style="width: 54px; height: 54px; border-radius: 16px; background: white; display: flex; align-items: center; justify-content: center; font-size: 1.75rem; box-shadow: 0 4px 12px rgba(14, 165, 233, 0.15); flex-shrink: 0;">✨</div>
        <div style="flex: 1;">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.4rem;">
                <h3 style="font-family: 'Outfit', sans-serif; font-size: 0.95rem; font-weight: 800; color: #0369a1; text-transform: uppercase; letter-spacing: 0.05em;">Aria's Insight</h3>
                <button onclick="getAriaInsight()" id="insightRefreshBtn" style="background: none; border: none; color: #0284c7; cursor: pointer; font-size: 0.75rem; font-weight: 700; text-transform: uppercase;">Refresh ✨</button>
            </div>
            <p id="ariaInsightText" style="color: #0c4a6e; font-size: 0.95rem; line-height: 1.6; font-weight: 500; font-style: italic;">
