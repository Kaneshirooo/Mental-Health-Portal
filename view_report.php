...
<div class="container" style="max-width: 900px; padding-top: 1.5rem; padding-bottom: 3rem;">
    <div class="report-view" style="animation: fadeInUp 0.6s ease-out;">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem; margin-bottom: 1.5rem;">
            <!-- Overall Score Card -->
            <div class="card" style="padding: 2rem; background: white; position: relative; overflow: hidden; border-radius: var(--radius);">
                ...
                <div style="display: flex; align-items: center; gap: 1.5rem;">
                    <div style="width: 100px; height: 100px; border-radius: 50%; border: 6px solid #f0fdfa; display: flex; align-items: center; justify-content: center; position: relative; background: white;">
        ...
        <!-- Detailed Metrics -->
        <div class="card" style="padding: 2.5rem; margin-bottom: 1.5rem; border-radius: var(--radius);">
...
endforeach; ?>
        ...
        <div class="card" style="padding: 2.5rem; background: #f0fdfa; border: 1px solid rgba(13, 148, 136, 0.15); margin-bottom: 1.5rem; position: relative; border-radius: var(--radius);">
            ...
            <h2 style="font-family: 'Outfit', sans-serif; font-size: 1.15rem; font-weight: 700; color: var(--primary-dark); margin-bottom: 1rem;">Recommendations</h2>
            <div style="background: white; padding: 1.75rem; border-radius: var(--radius-sm); border: 1px solid rgba(13, 148, 136, 0.1); box-shadow: var(--shadow-sm);">
                ...
                <?php if ($counselor_note['recommendation']): ?>
                    <div style="background: #f0fdfa; padding: 1.25rem; border-radius: var(--radius-sm); border-left: 3px solid var(--primary); margin-bottom: 1.5rem;">
        ...
        <div style="background: var(--surface-2); padding: 2rem; border-radius: var(--radius); text-align: center; border: 1px solid var(--border);">
            ...
            <div style="display: flex; gap: 0.75rem; justify-content: center;">
                ...
                <a href="anonymous_notes.php" class="btn-secondary" style="padding: 0.65rem 1.5rem; border-radius: var(--radius-sm); border: 1.5px solid var(--border); text-decoration: none; color: var(--text-muted); font-weight: 600; font-size: 0.85rem; background: white;">Message Counselor</a>
            </div>
        </div>
    </div>
</div>
