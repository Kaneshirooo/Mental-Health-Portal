...
<div class="container" style="max-width: 1200px; padding-top: 1.5rem; padding-bottom: 3rem;">
    ...
    <div style="display: flex; justify-content: space-between; align-items: flex-end; margin-bottom: 3rem;">
        ...
        <div style="display: flex; gap: 0.75rem;">
            ...
            <button onclick="window.print()" style="padding: 0.6rem 1.25rem; border-radius: var(--radius-sm); border: 1.5px solid var(--border); background: white; font-weight: 600; cursor: pointer; font-size: 0.85rem;">Print Agenda</button>
        </div>
    </div>
    ...
    <?php else: ?>
        <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(400px, 1fr)); gap: 1.25rem;">
            ...
            ?>
            <div style="background: white; border-radius: var(--radius); padding: 2rem; border: 1px solid var(--border); box-shadow: var(--shadow-sm); position: relative; transition: var(--transition);">
                ...
                <div style="display: flex; gap: 0.75rem;">
                    ...
                    <button onclick="this.nextElementSibling.style.display=this.nextElementSibling.style.display==='block'?'none':'block'" style="padding: 0.75rem 1.25rem; border-radius: var(--radius-sm); background: white; border: 1px solid var(--border); color: var(--text-muted); font-weight: 600; cursor: pointer;">•••</button>
                    <div style="display: none; position: absolute; bottom: 1.5rem; right: 1.5rem; background: white; border-radius: var(--radius-sm); padding: 0.75rem; box-shadow: var(--shadow-lg); border: 1px solid var(--border); z-index: 10;">
...
<div id="rescheduleModal" style="display:none; position:fixed; inset:0; z-index:9999; background:rgba(15,23,42,0.4); backdrop-filter:blur(4px); align-items:center; justify-content:center;">
    <div style="background:white; border-radius:var(--radius); padding:2rem; max-width:400px; width:90%; box-shadow:var(--shadow-lg); border: 1px solid var(--border);">
        ...
        <form id="rescheduleForm" onsubmit="return submitReschedule(event)">
            ...
            <div style="display:flex; gap:0.75rem;">
                <button type="button" onclick="closeRescheduleModal()" style="flex:1; padding:0.75rem; border-radius:var(--radius-sm); border:1.5px solid var(--border); background:white; font-weight:600; cursor:pointer; font-size:0.85rem;">Cancel</button>
