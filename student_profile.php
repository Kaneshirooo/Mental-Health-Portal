...
<div class="container" style="max-width: 1200px; padding-top: 1.5rem; padding-bottom: 3rem;">
        ...
        <div style="display: flex; align-items: center; gap: 1.5rem;">
            ...
            <div>
                <div style="display: flex; align-items: center; gap: 0.75rem; margin-bottom: 0.35rem;">
                    ...
                    <button id="generateAISummary" class="btn-sm" style="padding: 0.25rem 0.65rem; border-radius: 4px; background: white; border: 1.5px solid var(--primary); color: var(--primary); font-weight: 700; font-size: 0.65rem; cursor: pointer; display: flex; align-items: center; gap: 0.4rem; transition: var(--transition-fast);">
                        ✨ Generate AI Summary
                    </button>
                </div>
    ...
    <div id="aiSummaryBox" style="display: none; margin-bottom: 2.5rem; background: #f0fdfa; border: 1.5px solid rgba(13, 148, 136, 0.2); border-radius: var(--radius); padding: 2rem; position: relative; animation: fadeInUp 0.5s ease;">
        ...
        <div style="display: flex; align-items: center; gap: 0.75rem; margin-bottom: 1.5rem;">
            ...
            <span style="font-size: 0.7rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em; color: var(--text-dim); background: white; padding: 0.2rem 0.6rem; border-radius: 4px;">Gemini Powered</span>
        </div>
