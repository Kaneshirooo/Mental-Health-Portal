...
<div class="container" style="max-width: 1000px; padding-top: 1.5rem; padding-bottom: 3rem;">
    ...
    <!-- Identity Header -->
    <div style="display: flex; align-items: center; gap: 2rem; margin-bottom: 2.5rem; background: white; padding: 2rem; border-radius: var(--radius); border: 1px solid var(--border); box-shadow: var(--shadow-sm); position: relative; overflow: hidden;">
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; align-items: start;">
        ...
        <!-- Personal info -->
        <div style="background: white; border-radius: var(--radius); padding: 2rem; border: 1px solid var(--border); box-shadow: var(--shadow-sm);">
        ...
        <!-- Password change -->
        <div class="card" style="padding: 2rem; border-radius: var(--radius); background: #1e293b; color: white;">
            <h2 style="font-family: 'Outfit', sans-serif; font-weight: 700; margin-bottom: 1.5rem; display: flex; align-items: center; gap: 0.6rem; color: white; font-size: 1.15rem;">
                <span style="background: rgba(255,255,255,0.1); width: 32px; height: 32px; border-radius: 8px; display: flex; align-items: center; justify-content: center; font-size: 0.9rem;">🔐</span>
                Change Password
            </h2>
            <div class="form-group" style="margin-bottom: 1.25rem;">
                <label style="font-weight: 600; font-size: 0.78rem; color: rgba(255,255,255,0.5); display: block; margin-bottom: 0.5rem;">Current Password</label>
                <div style="position: relative;">
                    <input type="password" id="current_password" placeholder="Enter current password" style="width: 100%; padding: 0.85rem 3rem 0.85rem 1.25rem; border-radius: var(--radius-sm); border: 1px solid rgba(255,255,255,0.1); background: rgba(0,0,0,0.2); color: white; font-family: inherit;"
                           oninput="syncHidden()">
            ...
            <div class="form-group" style="margin-bottom: 1.25rem;">
                <label style="font-weight: 600; font-size: 0.78rem; color: rgba(255,255,255,0.5); display: block; margin-bottom: 0.5rem;">New Password</label>
                <div style="position: relative;">
                    <input type="password" id="new_password" placeholder="Min. 6 characters" style="width: 100%; padding: 0.85rem 3rem 0.85rem 1.25rem; border-radius: var(--radius-sm); border: 1px solid rgba(255,255,255,0.1); background: rgba(0,0,0,0.2); color: white; font-family: inherit;"
                ...
                <div style="height: 3px; background: rgba(255,255,255,0.1); border-radius: 6px; margin-top: 0.75rem; overflow: hidden;">
                    <div id="strengthBar" style="width: 0%; height: 100%; transition: var(--transition);"></div>
                </div>
                <div id="strengthLabel" style="font-size: 0.68rem; font-weight: 600; text-transform: uppercase; margin-top: 0.35rem; color: rgba(255,255,255,0.3);">Password Strength</div>
            </div>

            <div class="form-group">
                <label style="font-weight: 600; font-size: 0.78rem; color: rgba(255,255,255,0.5); display: block; margin-bottom: 0.5rem;">Confirm Password</label>
                <div style="position: relative;">
                    <input type="password" id="confirm_password" placeholder="Repeat new password" style="width: 100%; padding: 0.85rem 3rem 0.85rem 1.25rem; border-radius: var(--radius-sm); border: 1px solid rgba(255,255,255,0.1); background: rgba(0,0,0,0.2); color: white; font-family: inherit;"
