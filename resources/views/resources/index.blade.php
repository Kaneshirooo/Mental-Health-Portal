...
<div class="container" style="max-width: 1400px; padding-top: 5rem; padding-bottom: 8rem;">
    ...
    <div style="display: flex; justify-content: space-between; align-items: flex-end; margin-bottom: 6rem;">
        <div>
            ...
            <h1 style="font-family: 'Outfit', sans-serif; font-size: 3.5rem; font-weight: 800; color: var(--primary); margin-bottom: 0.75rem;">Clinical Resources</h1>
    ...
    <div style="margin-bottom: 6rem;">
        <div style="display: flex; align-items: center; gap: 1rem; margin-bottom: 3rem;">
            ...
            <h2 style="font-family: 'Outfit', sans-serif; font-size: 2.25rem; font-weight: 800; color: var(--text);">Immediate Clinical Support</h2>
        </div>
    ...
    <div style="background: var(--surface-2); border-radius: 48px; padding: 5rem; border: 1px solid var(--border); margin-bottom: 6rem;">
        <div style="text-align: center; max-width: 800px; margin: 0 auto 5rem auto;">
            <h2 style="font-family: 'Outfit', sans-serif; font-size: 2rem; font-weight: 800; color: var(--text); margin-bottom: 1.5rem;">Clinical Directives & Documentation</h2>
    ...
    <div style="background: linear-gradient(135deg, var(--primary) 0%, var(--primary-dark) 100%); border-radius: 48px; padding: 6rem; text-align: center; color: white; box-shadow: 0 40px 80px rgba(67, 56, 202, 0.25); position: relative; overflow: hidden;">
        ...
        <div style="position: relative; z-index: 1;">
            ...
            <div style="display: flex; gap: 2rem; justify-content: center;">
                <a href="{{ route('student.assessment') }}" style="padding: 1.5rem 4rem; border-radius: 50px; background: white; color: var(--primary); font-weight: 800; text-decoration: none; font-size: 1.1rem; box-shadow: 0 15px 30px rgba(0,0,0,0.1);">START ASSESSMENT</a>
                <a href="{{ route('student.notes.index') }}" style="padding: 1.5rem 4rem; border-radius: 50px; background: rgba(255,255,255,0.15); color: white; font-weight: 800; text-decoration: none; font-size: 1.1rem; border: 1px solid rgba(255,255,255,0.3); backdrop-filter: blur(10px);">ANONYMOUS INQUIRY</a>
            </div>
        </div>
    </div>
</div>
...
<footer class="footer" style="padding: 4rem; text-align: center; border-top: 1px solid var(--border); margin-top: 4rem;">
    <p style="color: var(--text-dim); font-weight: 700; font-size: 0.9rem; letter-spacing: 0.05em; text-transform: uppercase;">© {{ date('Y') }} Mental Health Clinical Ecosystem. High-Fidelity Wellness Stewardship.</p>
</footer>
@endsection
