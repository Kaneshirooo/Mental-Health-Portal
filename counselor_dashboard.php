...
<div class="container" style="max-width: 1200px; padding-top: 1.5rem; padding-bottom: 3rem;">
                ...
                <?php
                    ...
                    <tr style="transition: var(--transition);">
                        ...
                        <td style="text-align: right;">
                            <a href="student_profile.php?user_id=<?php echo $student['user_id']; ?>" style="display: inline-block; padding: 0.5rem 1rem; border-radius: var(--radius-sm); background: white; border: 1.5px solid var(--border); text-decoration: none; font-weight: 600; color: var(--primary); font-size: 0.8rem; transition: var(--transition);">Manage Case</a>
                        </td>
                    </tr>
                    <?php
    endwhile; ?>
    ...
    <!-- Anonymous Notes -->
    <div style="background: white; border-radius: var(--radius); border: 1px solid var(--border); padding: 2rem; box-shadow: var(--shadow-sm);">
            ...
            <div class="dialog-vault">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.5rem; border-bottom: 1px solid var(--border); padding-bottom: 1rem;">
                    ...
                    <div style="display: flex; gap: 0.5rem;">
                        <span style="padding: 0.3rem 0.75rem; border-radius: 4px; background: white; border: 1px solid var(--border); font-size: 0.65rem; font-weight: 700; color: var(--text-muted); text-transform: uppercase;">
                ...
                <div style="max-height: 250px; overflow-y: auto; padding-right: 0.75rem; margin-bottom: 1.5rem;" class="custom-scroll">
                    ...
                    <div style="margin-bottom: 1.25rem; display: flex; flex-direction: column; align-items: <?php echo($msg['sender_type'] === 'student') ? 'flex-start' : 'flex-end'; ?>;">
                        ...
                        <div class="message-bubble-counselor" style="<?php echo($msg['sender_type'] === 'student') ? 'background: white; border: 1.5px solid var(--border); color: var(--text); border-bottom-left-radius: 2px;' : 'background: var(--primary); color: white; border-bottom-right-radius: 2px;'; ?>">
