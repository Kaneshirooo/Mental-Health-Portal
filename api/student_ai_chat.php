...
<head>
    ...
    <style>
        ...
        @keyframes pulse-aria {
            0%, 100% { transform: scale(1); box-shadow: 0 16px 32px rgba(79, 70, 229, 0.12); }
            50%       { transform: scale(1.04); box-shadow: 0 24px 48px rgba(79, 70, 229, 0.2); }
        }
        ...
        .online-badge span { width: 8px; height: 8px; background: #10b981; border-radius: 50%; box-shadow: 0 0 8px #10b981; }
        ...
        .stat-lbl { font-size: 0.72rem; font-weight: 800; color: var(--text-dim); text-transform: uppercase; letter-spacing: 0.05em; }
        .stat-val { font-weight: 800; color: var(--primary); font-size: 0.88rem; }
        ...
        .user-row .msg-bubble {
            ...
            box-shadow: 0 10px 24px rgba(67, 56, 202, 0.2);
        }
        ...
        .msg-input:focus { outline: none; background: white; border-color: var(--primary-light); box-shadow: 0 0 0 5px rgba(79,70,229,0.06); }
        ...
        .send-btn:hover { transform: translateY(-4px); box-shadow: 0 14px 28px rgba(67,56,202,0.3); }
        ...
        .starter-tag:hover { border-color: var(--primary); color: var(--primary); background: var(--primary-glow); transform: translateY(-2px); }
...
<div class="chat-layout">
    ...
    <div class="aria-panel">
        ...
        <h2 style="font-family:'Outfit',sans-serif; font-weight:800; color:var(--primary-dark); font-size:1.75rem; margin-bottom:1rem;">Meet Aria</h2>
